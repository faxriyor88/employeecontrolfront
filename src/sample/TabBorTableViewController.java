...
public class TabBorTableViewController implements Initializable {
    @FXML
    ...
    public void showMuddatiBor() {

        try {
            String rangi = "GREEN";
            List<DocumentEffectorDtoResponse> dtoResponses = ConnectEmployeeController.getAllDocumentEffector(rangi);
            bor = dtoResponses.size() + "";
            if (dtoResponses.size() != 0) {
//                File gr = new File("src/sample/image/green.png");
//                Image green = new Image(gr.toURI().toString());
//                ImageView grview = new ImageView();
//                grview.setFitWidth(25);
//                grview.setFitHeight(25);
//                grview.setImage(green);
                ...
                originalfilename.setCellFactory(param -> new TableCell<ShowDocument, ShowDocument>() {
                    ...
                    protected void updateItem(ShowDocument item, boolean empty) {
                        if (!empty) {
                            ...
                            Image download = new Image(delete.toURI().toString());
                            ImageView imageView = new ImageView(download);
