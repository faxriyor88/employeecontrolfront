...
public class TabKelganTableViewController implements Initializable {
    @FXML
    ...
    public void showMuddatiKelgan() {

        try {
            String rangi = "YELLOW";
            List<DocumentEffectorDtoResponse> dtoResponses = ConnectEmployeeController.getAllDocumentEffector(rangi);
            kelgan = dtoResponses.size() + "";
            if (dtoResponses.size() != 0) {

//                File yellow = new File("src/sample/image/yellow.png");
//                Image yelcolor = new Image(yellow.toURI().toString());
//
//                ImageView yelview = new ImageView();
//                yelview.setFitWidth(25);
//                yelview.setFitHeight(25);
//
//                yelview.setImage(yelcolor);
